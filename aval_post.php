...
.hero_area_aval_post {
  ...
  -webkit-box-direction: normal;
      -ms-flex-direction: column;
          ...
          background-image: url(../images/avaliaçao_postural.png);
...
<body>
  ...
  <div class="content-container">
    <div class="text">
      <div class="words">
      <h1>Sobre a Avaliação Postural</h1>
      <br><br>
      <p>
      A avaliação postural é um procedimento que analisa a posição e o alinhamento do corpo em relação aos seus eixos e segmentos. Ela visa identificar desequilíbrios musculares, desvios posturais e possíveis causas de dores ou desconfortos. Este processo é fundamental para a elaboração de programas de reabilitação e prevenção de lesões.
      </p>
      </div>
    </div>
    <div class="image">
      <img src="images/aval_post.jpg" alt="Fisioterapia Desportiva">
    </div>
