...
<a href="" onclick="Calendly.initPopupWidget({url: 'https://calendly.com/tanjilkh/fisioterapia-desportiva'});return false;"><button class="button-57" role="button"><span class="text">Fisioterapia Desportiva</span><span>Marcar <br> Agora</span></button></a>
